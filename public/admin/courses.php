    ...
    <div
        ...
        <div
            ...
            <div class="flex-none hidden lg:block">
                <h1 class="text-[10px] font-black uppercase tracking-[0.3em] text-blue-100/70">Academic Programs Center
                </h1>
            </div>
        ...
        <main class="p-6 md:p-10 max-w-7xl w-full mx-auto flex-grow">
            ...
            <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <div
                    ...
                    <?php echo count($row); ?> Total Programs
                </div>
            </div>

            <!-- Master Course Data Table Container -->
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-24">
                                    <div class="flex flex-col items-center text-slate-400">
                                        ...
                                        <span class="text-lg font-bold tracking-tight text-slate-500">No active degree
                                            paths map to the index.</span>
                                    </div>
                                </td>
                            </tr>
                            <?php } else { ?>
                            ...
                            <tr class="hover:bg-blue-50/60 transition-all duration-200 group">
                                ...
                                <td class="py-4 px-6">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-2 h-2 rounded-full bg-blue-6600 bg-blue-600 opacity-0 group-hover:opacity-100 transition-opacity">
                                        </div>
                                        <span
...
<dialog id="createModal" class="modal">
    <div
        ...
        <div class="bg-blue-700 p-6 relative">
            <h2 class="text-lg font-black text-white uppercase tracking-wider text-center">Create Course</h2>
            ...
            <form id="createForm" class="space-y-4">
                ...
                <div class="form-control">
                    <label class="label"><span
                            class="label-text font-black text-slate-700 uppercase text-[10px] tracking-widest">Department</span></label>
                    <select id="departmentId" name="departmentId"
                        ...
                        required>
                        <option value="" disabled selected class="text-slate-400">Select Department</option>
                ...
                <div class="form-control">
                    <label class="label"><span
                            class="label-text font-black text-slate-700 uppercase text-[10px] tracking-widest">Program
                            Course Title</span></label>
                ...
                <div class="form-control">
                    <label class="label"><span
                            class="label-text font-black text-slate-700 uppercase text-[10px] tracking-widest">Program
                            Code Index</span></label>
                    <input type="text" id="couCode" name="couCode" placeholder="e.g., BSA"
...
<dialog id="editModal" class="modal">
    <div
        class="modal-box w-full max-w-md bg-white p-0 overflow-hidden rounded-2xl shadow-2xl border border-blue-400/20">
        <div class="bg-blue-700 p-6 relative">
            <h2 class="text-lg font-black text-white uppercase tracking-wider text-center">Edit Course</h2>
            <div class="absolute bottom-0 left-0 w-full h-[3px] bg-blue-400"></div>
        </div>
        ...
        <div class="p-6 bg-slate-50/50">
            ...
            <form id="editForm" class="space-y-4">
                ...
                <div class="form-control">
                    <label class="label"><span
                            class="label-text font-black text-slate-700 uppercase text-[10px] tracking-widest">Course
                            Name</span></label>
