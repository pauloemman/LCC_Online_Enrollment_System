...
<div class="h-screen w-screen bg-cover bg-center bg-no-repeat bg-fixed overflow-hidden flex flex-col"
    ...
    <div class="h-full w-full bg-slate-900/40 backdrop-blur-[2px] flex flex-col">
        ...
        <div class="drawer lg:drawer-open h-full overflow-hidden">
            ...
            <div
                ...
                <main class="p-6 md:p-12 max-w-6xl w-full mx-auto flex-grow">
                    ...
                    <div
                        ...
                        <!-- Sidebar Info & Announcements (1/3 Width) -->
                        <div
                            class="bg-slate-50/80 p-8 lg:w-1/3 border-l border-slate-100 flex flex-col justify-between gap-8">
                            <div class="space-y-6">
                                <h4
                                    class="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] text-center">
                                    Announcements
                                </h4>
                                ...
                                <div class="space-y-4">
                                    <!-- Deadline Card -->
                                    <div
                                        class="alert bg-white border border-slate-200 shadow-sm rounded-2xl flex items-center gap-4 p-4">
                                        <div
                                            class="h-10 w-10 bg-rose-100 text-rose-600 rounded-xl flex items-center justify-center font-bold flex-shrink-0">
                                            15
                                        </div>
                                        <div class="text-xs">
            ...
            <!-- Persistent Sidebar Desktop Drawer -->
            <div class="drawer-side z-40">
                ...
                <div class="w-72 min-h-full bg-white border-r border-slate-200 p-6 flex flex-col shadow-2xl">
                    ...
                    <ul class="menu menu-md p-0 space-y-2 flex-grow">
                        ...
                        <li>
                            <div
                                class="flex items-center justify-between py-3 px-4 rounded-xl bg-slate-50 border border-slate-200">
                                ...
                                <?php } elseif ($studentStatus == 'Pending') { ?>

                                <span class="badge badge-warning font-bold">
                                    Pending
                                </span>

                                <?php } elseif ($studentStatus == 'Rejected') { ?>

                                <span class="badge badge-error text-white font-bold">
                                    Rejected
                                </span>
