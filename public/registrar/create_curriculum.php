<?php session_start();
include('includes/curHeader.php'); ?>

<?php
include('../../classes/registrar.php');

$data = new registrar();
$row = $data->viewCurriculum();
...
<div class="min-h-screen bg-slate-50">
    ...
    <div class="navbar bg-base-100 shadow-sm border-b border-slate-200 px-4 md:px-8 sticky top-0 z-30">
        ...
        <div class="flex-none hidden lg:block">
            <h1 class="text-sm font-semibold uppercase tracking-widest text-slate-500">Curriculum Management</h1>
        </div>
    ...
    <div class="max-w-6xl mx-auto p-6 md:p-10">
        ...
        <div class="flex flex-col md:flex-row items-baseline justify-between mb-8 gap-2">
            <div>
                ...
                <p class="text-slate-500 text-sm mt-1">Manage Curriculums.</p>
            </div>
            <div class="badge badge-lg bg-blue-50 text-blue-700 border-blue-100 font-medium px-4 py-3">
                <?php echo count($row); ?> Total Curriculum
            </div>
        </div>
                ...
                <form id="createForm" class="space-y-4">
                    ...
                    <div class="form-control">
                        <label class="label"><span
                                class="label-text font-bold text-slate-600 uppercase text-[10px]">School Year
                            </span></label>
                        <input type="text" id="sYear" name="sYear" placeholder="SY 2025-2026"
...
<?php include('includes/curFooter.php'); ?>