            ...
            <div
                ...
                <div class="bg-gradient-to-br from-blue-600 to-blue-800 p-8 text-center relative overflow-hidden">
                    ...
                    <h2 class="text-3xl font-black text-white tracking-tight relative z-10 italic uppercase">
                        Create <span class="text-blue-200">Account</span>
                    </h2>
                    <p
                ...
                <div class="card-body p-8 space-y-3">
                    <div class="form-control">
                        <label class="label pb-1">
                            <span
                                class="label-text font-black text-slate-400 uppercase text-[9px] tracking-[0.15em]">Full
                                Name</span>
                        </label>
                    ...
                    <div class="form-control">
                        <label class="label pb-1">
                            <span
                                class="label-text font-black text-slate-400 uppercase text-[9px] tracking-[0.15em]">Create
                                Password</span>
                        </label>
                    ...
                    <div class="pt-2">
                        <button type="button"
                            class="btn btn-primary w-full h-12 shadow-xl shadow-blue-200 border-none bg-blue-600 text-white font-black text-xs uppercase tracking-[0.2em] hover:bg-blue-700 hover:scale-[1.03] active:scale-[0.97] transition-all rounded-2xl --btn-register">
                            Register Now
                        </button>
                    </div>
